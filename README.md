...
- **Mentions Discord** : dans le message du matin, la personne assignée à une tâche du jour est @-mentionnée directement sur la ligne de sa tâche. Le titre de chaque tâche est aussi un lien cliquable qui ouvre directement cette tâche sur le site
- Note : ces mentions sont dans le corps du message (pas dans la zone qui déclenche une vraie notification push Discord) — c'est un choix volontaire pour garder le message propre sans ligne de @ en haut
